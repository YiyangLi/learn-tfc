...
export class LogsApi extends runtime.BaseAPI {
     ...
     * Get logs
     */
    async getLogsRaw(requestParameters: GetLogsRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Blob>> {
     ...
     * Get logs
     */
    async getLogs(requestParameters: GetLogsRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<Blob> {
