...
export function CompleteDestinationOAuthRequestFromJSON(json: any): CompleteDestinationOAuthRequest {
    return CompleteDestinationOAuthRequestFromJSONTyped(json, false);
}

export function CompleteDestinationOAuthRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CompleteDestinationOAuthRequest {
...
export function CompleteDestinationOAuthRequestToJSON(value?: CompleteDestinationOAuthRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
