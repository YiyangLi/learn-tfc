...
import {
    ...
    FieldNameAndSchemaFromJSONTyped,
    FieldNameAndSchemaToJSON,
} from './FieldNameAndSchema';
import {
    FieldSchemaUpdate,
    FieldSchemaUpdateFromJSON,
    FieldSchemaUpdateFromJSONTyped,
    FieldSchemaUpdateToJSON,
} from './FieldSchemaUpdate';
...
export function FieldTransformFromJSON(json: any): FieldTransform {
    return FieldTransformFromJSONTyped(json, false);
}

export function FieldTransformFromJSONTyped(json: any, ignoreDiscriminator: boolean): FieldTransform {
...
export function FieldTransformToJSON(value?: FieldTransform | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
