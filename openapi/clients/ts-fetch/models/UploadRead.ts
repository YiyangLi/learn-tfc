...
export function UploadReadFromJSON(json: any): UploadRead {
    return UploadReadFromJSONTyped(json, false);
}

export function UploadReadFromJSONTyped(json: any, ignoreDiscriminator: boolean): UploadRead {
...
export function UploadReadToJSON(value?: UploadRead | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
