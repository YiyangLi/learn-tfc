...
export function StreamTransformFromJSON(json: any): StreamTransform {
    return StreamTransformFromJSONTyped(json, false);
}

export function StreamTransformFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamTransform {
...
export function StreamTransformToJSON(value?: StreamTransform | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
