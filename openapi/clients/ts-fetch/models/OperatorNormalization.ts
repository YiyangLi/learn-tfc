...
export function OperatorNormalizationFromJSON(json: any): OperatorNormalization {
    return OperatorNormalizationFromJSONTyped(json, false);
}

export function OperatorNormalizationFromJSONTyped(json: any, ignoreDiscriminator: boolean): OperatorNormalization {
...
export function OperatorNormalizationToJSON(value?: OperatorNormalization | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
