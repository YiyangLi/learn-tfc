...
export function SourceDefinitionIdRequestBodyFromJSON(json: any): SourceDefinitionIdRequestBody {
    return {
        'sourceDefinitionId': json['sourceDefinitionId'],
    };
}

export function SourceDefinitionIdRequestBodyToJSON(value?: SourceDefinitionIdRequestBody): any {
    if (value === undefined) {
        return undefined;
    }
    return {
