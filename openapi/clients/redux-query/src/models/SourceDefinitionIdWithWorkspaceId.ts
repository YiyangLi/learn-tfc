...
export function SourceDefinitionIdWithWorkspaceIdFromJSON(json: any): SourceDefinitionIdWithWorkspaceId {
    return {
...
export function SourceDefinitionIdWithWorkspaceIdToJSON(value?: SourceDefinitionIdWithWorkspaceId): any {
    if (value === undefined) {
        return undefined;
    }
    return {
