...
export function DestinationDefinitionCreateFromJSON(json: any): DestinationDefinitionCreate {
    return {
        'name': json['name'],
...
export function DestinationDefinitionCreateToJSON(value?: DestinationDefinitionCreate): any {
    if (value === undefined) {
        return undefined;
    }
    return {
