...
export function PrivateDestinationDefinitionReadFromJSON(json: any): PrivateDestinationDefinitionRead {
    return {
...
export function PrivateDestinationDefinitionReadToJSON(value?: PrivateDestinationDefinitionRead): any {
    if (value === undefined) {
        return undefined;
    }
    return {
