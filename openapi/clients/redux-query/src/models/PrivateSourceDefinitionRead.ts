...
export function PrivateSourceDefinitionReadFromJSON(json: any): PrivateSourceDefinitionRead {
    return {
...
export function PrivateSourceDefinitionReadToJSON(value?: PrivateSourceDefinitionRead): any {
    if (value === undefined) {
        return undefined;
    }
    return {
